...
| <a name="input_custom_tags"></a> [custom\_tags](#input\_custom\_tags) | Optional tags to be applied on top of the base tags on all resources | `map(string)` | `{}` | no |
...
| <a name="input_logging_bucket_encryption"></a> [logging\_bucket\_encryption](#input\_logging\_bucket\_encryption) | Enable default bucket encryption. i.e. AES256 \| aws:kms | `string` | `"AES256"` | no |
...
| <a name="input_logging_bucket_name"></a> [logging\_bucket\_name](#input\_logging\_bucket\_name) | Bucket name to store s3 flow logs. If empty, to create random bucket name. In conjuction with build\_s3\_flow\_logs | `string` | `""` | no |
...
| <a name="input_logging_bucket_retention"></a> [logging\_bucket\_retention](#input\_logging\_bucket\_retention) | The number of days to retain load balancer logs. 0 to ratain forever. | `string` | `"14"` | no |
